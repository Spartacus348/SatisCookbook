...
use crate::objects::{Process, Amount, Building::*, Part,
                     Conveyable::*, Mineable::*, Pipeable::*, Pumpable::*,
                     Conveyable, Mineable, Pumpable, Pipeable};
use crate::objects::Part::Conveyor;
...
pub(crate) fn get_proper_names<'a>() -> HashMap<&'a str, Part>{HashMap::from([
